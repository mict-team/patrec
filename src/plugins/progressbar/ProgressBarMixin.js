...
export const ProgressBarMixin = {
  ...
  computed: {
    ...
    lineStyleSvgFrame() {
      return {
        height: ph(this.defaultOptions.layout.height),
    ...
    textStyle() {
      return {
        ...
        fontSize: ph(this.defaultOptions.text.fontSize),
    ...
    textStyleCircle() {
      return {
        ...
        textShadow: this.defaultOptions.text.shadowEnable
          ? "1px 1px 1px " + this.defaultOptions.text.shadowColor
          : "none",
        top: ph(this.defaultOptions.layout.verticalTextAlign),
        left: ph(this.defaultOptions.layout.horizontalTextAlign),
        position: "relative"
      };
    },
    progressColor() {
