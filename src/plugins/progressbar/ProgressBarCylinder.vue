<template>
  <div id="progress-bar-cylinder">
    <svg id="cylinder-progress" width="150px" height="120px">
      <g
      ...
      >
        ...
        <ellipse cx="75" cy="20" rx="50%" ry="15" class="top" />
        <ellipse cx="75" cy="100" rx="50%" ry="15" class="bottom" />
      </g>
      <g
      ...
      >
        <rect x="0" :y="rectY" width="100%" :height="rectHeight" />
        <ellipse cx="75" :cy="topCy" rx="50%" ry="15" class="top" />
        <ellipse cx="75" cy="100" rx="50%" ry="15" class="bottom" />
      </g>
