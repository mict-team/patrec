                ...
                <div class="portlet light" style="padding:0px;">
                  <div class="portlet-body ">
                    <div class="receipt ">
                      <table>
                        <tr>
                          <td style="width:25%;"><img :src="logo" alt="Rev logo" class="logo" style="width:82px; height:82px;" /></td>
                          <td>
                            <v-flex xs12 class="title" style="font-size:17px !important; font-weight:bold">{{outlet.outlet}}</v-flex>
                      ...
                      <table>
                        <tr>
                          <th>Name: </th><td colspan="5">{{ carts.customer.name }}</td>
                        </tr>
                        <tr>
                          <th style="width:20%">Card no:</th><td style="width:25%">{{ carts.customer.file }}</td>
                          <th> DOB: </th><td style="width:20%">{{ carts.customer.dob }}</td>
                          <th> Sex: </th><td style="width:20%">{{ carts.customer.gender }}</td>
                        </tr>
                      </table>
                      <v-spacer></v-spacer>
                      ...
                      <table class="table table-hover" cellpadding="5px" cellspacing="5px" >
                        <tr
                          ...
                          <td>{{ index + 1 }}</td>
                          <td>{{ cart.qty_sold }}</td>
                          <td>{{ cart.name }}({{ cart.revType | toTitleCase }})</td>
                          <td>&#8358;{{ cart.total | toDecimal }}</td>
                        </tr>
                      </table>
                      ...
                      <div class="panel-footer">
                        ...
                        <v-flex xs12 class="stamp" style="position: relative; float:right; right: 10% !important; top: -165px !important;">
                        <v-avatar size="100px" tile style="opacity:0.7">
                            <img :src="stamp" alt="paid stamp" class="rstamp" style="width:100px; height:100px;" />
                          </v-avatar>
                      </v-flex>
                      </div>
                    </div>
    ...
    methods: {
      ...
      printReceipt: function() {
        ...
        win.loadURL('data:text/html;charset=UTF-8,' + encodeURIComponent(content), {
          baseURLForDataURL: `file://${__dirname}/build/`
        })
