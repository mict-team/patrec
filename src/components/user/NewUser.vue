...
export default {
  ...
  methods: {
    ...
    generateCode: function() {
      var password = this.user.username || "patrec@abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";
    ...
    addUser: function() {
      ...
      (this.user.user = this.currentUser.id )
  ...
  mounted() {
    this.currentUser=LS.get('user');
    setTimeout(this.loadAccessGroup, 200);
    setTimeout(this.loadDept, 200);
