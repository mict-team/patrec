...
<v-container id="user-profile" fluid tag="section">
    <v-row justify="center">
      <v-col cols="12" md="8">
        <div>
          <v-row center>
            <v-col cols="12" md="4" @click="$router.push('/laboratory/requests')">
              <base-material-card
                :bar="false"
                class="primary text-start font-weight-light white--text"
              >
                <v-icon class="icons">person_add</v-icon>
                <h6>Requests</h6>
              </base-material-card>
            </v-col>
            <v-col cols="12" md="4" @click="$router.push('/laboratory/tests')">
              <base-material-card :bar="false" class="primary text-start white--text">
                <v-icon class="icons">mdi-bed-empty</v-icon>
                <h6>Tarrifs</h6>
              </base-material-card>
            </v-col>
            <v-col cols="12" md="4" @click="$router.push('/laboratory/lab-report')">
              <base-material-card :bar="false" class="primary text-start white--text">
