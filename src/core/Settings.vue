...
export default {
  ...
  data: () => ({
    ...
    image: "../assets/sidebars/sidebar-1.jpg",
    images: [
      "../assets/sidebars/sidebar-1.jpg",
      "../assets/sidebars/sidebar-2.jpg",
      "../assets/sidebars/sidebar-3.jpg",
      "../assets/sidebars/sidebar-4.jpg"
    ],
    menu: false,
    saveImage: "",
    showImg: true
